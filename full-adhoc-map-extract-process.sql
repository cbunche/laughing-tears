...
claim_header AS (
    SELECT
        ...
        RPAD(
            ...
            LPAD(
                COALESCE(ppr.payment_response_json->'providerCheck'->>'claimAmount', ''),
                7,
                '0'
            ...
            RPAD(
                LEFT(COALESCE(pc.claim_jsonb->>'medicareBeneficiaryIdentifier', ''), 11),
                11,
                ' '
    ...
    claim_line AS (
        ...
        RPAD(
            ...
            LPAD('', 3, '0') || -- 1389-1391: :P:IDR-K-LEG-RED-AUD
            ...
            LPAD('', 3, '0') ||	-- 2096-2098: :P:IDR-K-CPC-PERCENT
